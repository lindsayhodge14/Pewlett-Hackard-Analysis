...
## Analysis
As can be seen in the [a link(Pewlett-Hackard-Analysis/retiring_titles.csv)], the silver tsunami is going to bemost prominent amongst senior engineers and staff. 
...
Considering the loss ofhighly experienced and educated staff, it is vital that the company be prepared to fulfill such critical roles with new/up-and-coming talent. The [a link(Pewlett-Hackard-Analysis/mentorship_elligibility.csv)] helps to identify such individuals.
